...
<div class="mb-4">
    ...
    <div class="mt-1 relative rounded-md shadow-sm">
        <input
            ...
            class="block w-full pr-12 rounded-md border border-gray-700 bg-gray-900 text-gray-200 placeholder-gray-500 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
            placeholder="0"
        >
        @if($unit)

                            ...
                            <th class="border px-2 py-1 text-center text-xs italic text-gray-500 relative group">
                                @if($author !== '-')
                                    ...
                                    <div x-data="{ open: false }"
                                        ...
                                        class="hidden group-hover:block absolute z-20 bg-gray-800 text-white text-xs rounded-md p-2 w-40 -translate-x-1/2 left-1/2 bottom-full mb-1 shadow-lg">
                        ...
                        @foreach($categoryJamList[$catName] as $jam)
                            @php
                                ...
                                if (is_numeric($val)) {
                                    ...
                                    if ($displayName == 'Sat O2' && $val < 90) $cls = 'text-red-600 font-semibold';
                                } else {
                                    if ($val == '+') $cls = 'text-green-600 font-bold';
                                    if ($val == '-') $cls = 'text-red-600 font-bold';
                                }
                            @endphp

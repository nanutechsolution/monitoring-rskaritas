    ...
    >
        ...
        >
                ...
                <div class="grid grid-cols-1 md:grid-cols-5 gap-6 h-full">
                    ...
                    <div class="md:col-span-2 h-full max-h-[calc(80vh-150px)] overflow-y-auto pr-3 space-y-4
                        ...
                        <div
                            ...
                            @class([
                                'border p-3 rounded-lg bg-white dark:bg-gray-700 shadow-sm cursor-pointer transition duration-150 hover:bg-gray-50 dark:hover:bg-gray-600',
                                'border-primary-500 ring-2 ring-primary-100 dark:ring-primary-900' => $loop->first, // Highlight terbaru
                        ...
                        >
                            ...
                            <div class="text-sm text-gray-800 dark:text-gray-200 space-y-2">
                                <div><strong class="text-gray-600 dark:text-gray-400 block text-xs">1. Masalah Klinis:</strong><p class="pl-2">{!! nl2br(e($program->masalah_klinis)) !!}</p></div>
                                <div><strong class="text-gray-600 dark:text-gray-400 block text-xs">2. Program Terapi:</strong><p class="pl-2">{!! nl2br(e($program->program_terapi)) !!}</p></div>
                                <div><strong class="text-gray-600 dark:text-gray-400 block text-xs">3. Nutrisi Enteral:</strong><p class="pl-2">{!! nl2br(e($program->nutrisi_enteral)) !!}</p></div>
                                <div><strong class="text-gray-600 dark:text-gray-400 block text-xs">4. Nutrisi Parenteral:</strong><p class="pl-2">{!! nl2br(e($program->nutrisi_parenteral)) !!}</p></div>
                                <div><strong class="text-gray-600 dark:text-gray-400 block text-xs">5. Pemeriksaan Lab:</strong><p class="pl-2">{!! nl2br(e($program->pemeriksaan_lab)) !!}</p></div>
                            </div>
                        </div>
                        @empty
                    ...
                    <div class="md:col-span-3 space-y-5">
                        <div class="flex justify-between items-center mb-2">
                            ...
                            <button @click="resetForm()" type="button"
                                    class="px-3 py-1 bg-gray-100 dark:bg-gray-700
                        ...
                        <div>
                            ...
                            <textarea id="therapy_masalah" x-model="masalah" rows="3" class="{{ $inputClasses }}" placeholder="..."></textarea>
                        </div>
                        <div>
                            <label for="therapy_program" class="{{ $labelClasses }}">2. Program Terapi</label>
                            <textarea id="therapy_program" x-model="program" rows="4" class="{{ $inputClasses }}" placeholder="..."></textarea>
                        </div>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <label for="therapy_enteral" class="{{ $labelClasses }}">3. Nutrisi Enteral</label>
                                <textarea id="therapy_enteral" x-model="enteral" rows="3" class="{{ $inputClasses }}" placeholder="..."></textarea>
                            </div>
                            <div>
                                <label for="therapy_parenteral" class="{{ $labelClasses }}">4. Nutrisi Parenteral</label>
                                <textarea id="therapy_parenteral" x-model="parenteral" rows="3" class="{{ $inputClasses }}" placeholder="..."></textarea>
                            </div>
                        </div>
                        <div>
                            <label for="therapy_lab" class="{{ $labelClasses }}">5. Pemeriksaan Penunjang</label>
                            <textarea id="therapy_lab" x-model="lab" rows="3" class="{{ $inputClasses }}" placeholder="..."></textarea>
                        </div>
                    </div>
            ...
            <div class="px-6 py-4 bg-gray-50 dark:bg-gray-900 border-t border-gray-200 dark:border-gray-700 flex justify-end space-x-3">
                <button @click="showTherapyModal = false; resetForm()" type="button"
                        class="px-4 py-2 bg-white dark:bg-gray-700 text-sm font-medium text-gray-700 dark:text-gray-300
                ...
                <button
                    ...
                    type="button"
                    class="px-4 py-2 bg-primary-600 text-sm font-medium text-white border border-transparent

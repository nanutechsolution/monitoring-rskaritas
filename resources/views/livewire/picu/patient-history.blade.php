<div class="container mx-auto p-6 space-y-6">
    ...
    <div class="bg-white shadow-lg rounded-lg p-6 border-l-4 border-pink-600"> {{-- Warna pink untuk PICU --}}
        <div class="flex justify-between items-center">
            <div>
                ...
                <h3 class="text-xl font-semibold text-pink-700 mt-2">Riwayat Monitoring PICU</h3> {{-- Judul diubah --}}
            </div>
            <div class="text-right">
                {{-- Tombol kembali (sesuaikan URL) --}}

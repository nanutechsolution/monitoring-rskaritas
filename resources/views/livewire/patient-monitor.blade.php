<div>
    ...
    " class="space-y-4">
                                ...
                                <div class="space-y-3">
                                    <div>
                                        <label for="respiratory_mode" class="{{ $labelClasses }}">Mode Pernapasan</label>
                                        <select id="respiratory_mode" x-model="mode" class="{{ $selectClasses }}">
                                    ...
                                    <div x-show="mode === 'spontan'" x-transition>
                                        <div class="{{ $cardClasses }}">
                                            ...
                                            <div class="grid grid-cols-2 gap-4">
                                                <div>
                                                    <label class="{{ $labelClasses }}">FiO₂ (%)</label>
                                                    <input type="text" wire:model.defer="spontan_fio2" class="{{ $inputClasses }}">
                                                </div>
                                                <div>
                                                    <label class="{{ $labelClasses }}">Flow (Lpm)</label>
                                    ...
                                    <div x-show="mode === 'cpap'" x-transition>
                                        <div class="{{ $cardClasses }}">
                                            ...
                                            <div class="grid grid-cols-2 gap-4">
                                                ...
                                                <div>
                                                    <label class="{{ $labelClasses }}">PEEP (cmH₂O)</label>
                                        ...
                                        <div class="{{ $cardClasses }} p-4">
                                            ...
                                            <div class="grid grid-cols-2 gap-4 items-start">
                                                <div class="flex flex-col">
                                                    <label class="{{ $labelClasses }}">Mode</label>
                            ...
                            @if ($activeTab == 'cairan')
                            <div class="space-y-4">
                                @include('livewire.patient-monitor.partials.tab-input-cairan-nicu')
                            </div>
                            @endif
                        </div>
                    </div>

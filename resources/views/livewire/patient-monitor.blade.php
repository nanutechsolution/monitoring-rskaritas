            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 mb-6 px-4">
                ...
                <div class="flex flex-wrap items-center justify-between gap-4 mb-6">
                    ...
                    <div class="flex items-center gap-3">
                        <div class="p-2 rounded-xl bg-gradient-to-br from-teal-500 to-emerald-600 text-white shadow-md flex items-center justify-center">
                        ...
                        <div>
                            <h2 class="text-xl font-bold text-gray-800 leading-tight">
                                Monitoring 24 Jam <span class="bg-gradient-to-r from-teal-600 to-emerald-500 bg-clip-text text-transparent">NEONATUS INTENSIF CARE UNIT (NICU)</span>
                            </h2>
                            <p class="text-sm text-gray-500">Pemantauan kondisi pasien secara real-time</p>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-wrap items-center justify-end gap-2">
                        ...
                        <button wire:click="goToPreviousDay" type="button" title="Hari Sebelumnya" class="p-2 bg-white border border-gray-200 hover:bg-gray-100 rounded-md text-gray-600 transition-colors shadow-sm">
                        ...
                        <!-- Input tanggal -->
                        <input type="date" wire:model.blur="selectedDate" class="form-input py-2 px-3 text-sm rounded-md border-gray-300 shadow-sm focus:ring-teal-500 focus:border-teal-500">

                        <!-- Tombol Hari Berikutnya -->
                        <button wire:click="goToNextDay" type="button" title="Hari Berikutnya" class="p-2 bg-white border border-gray-200 hover:bg-gray-100 rounded-md text-gray-600 transition-colors shadow-sm disabled:opacity-50 disabled:cursor-not-allowed" @if(\Carbon\Carbon::parse($selectedDate)->isToday()) disabled @endif>
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <!-- Tombol Cetak -->
                        @if($currentCycleId)
                        <a href="{{ route('monitoring.report.pdf', ['no_rawat' => str_replace('/', '_', $no_rawat), 'cycle_id' => $currentCycleId]) }}" target="_blank" class="inline-flex items-center gap-2 px-3 py-2 border border-teal-600 text-teal-600 rounded-md hover:bg-teal-600 hover:text-white shadow-sm transition-colors">

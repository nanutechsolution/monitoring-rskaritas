    ...
    <div class="py-8">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 mb-6">
            ...
            <div class="flex flex-wrap items-center justify-end gap-2 mb-4">
                ...
                <!-- Input tanggal -->
                <input type="date" wire:model.live="selectedDate" class="form-input py-2 px-3 text-sm rounded-md border-gray-300 shadow-sm transition-colors focus:ring-teal-500 focus:border-teal-500">
            ...
            <div class="overflow-x-auto py-3 -mx-3 scroll-smooth scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100">
                <div class="flex gap-3 px-3 min-w-max snap-x snap-mandatory">
                    <!-- Catat Kejadian -->
                    <button type="button" wire:click="openEventModal" class="flex items-center gap-2 px-5 py-2 bg-white border rounded-lg shadow hover:shadow-md hover:bg-green-50 flex-shrink-0 snap-start transition-all">
                ...
                <form wire:submit="saveRecord" class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900">
                        ...
                        <div class="mt-4">
                            ...
                            <div class="mt-1 block w-full rounded-md border-gray-300 bg-gray-100 shadow-sm px-3 py-2 sm:text-sm" wire:poll.30s="updateRecordTime">{{ \Carbon\Carbon::parse($record_time)->format('d M Y, H:i') }}</div>
                        </div>
                    ...
                    <div class="bg-gray-50 px-4 py-3 space-y-3 border-t">
                        <div class="text-right">
                            <button type="submit" wire:loading.attr="disabled" class="inline-flex justify-center rounded-md border border-transparent bg-blue-600 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-blue-700">

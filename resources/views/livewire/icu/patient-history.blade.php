<div class="container mx-auto px-3 sm:px-6 py-4 sm:py-6 space-y-5">
    ...
    <div class="bg-white shadow-sm rounded-lg border-l-4 border-blue-600 px-3 py-3 sm:px-6 sm:py-4">
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2 sm:gap-3">
            ...
            <a href="{{-- isi URL kembali --}}"
               wire:navigate
               class="text-[11px] sm:text-sm text-blue-600 hover:text-blue-800 font-medium transition-colors">
                ← Kembali
            </a>
        </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-100 p-4 sm:p-5 text-center">
        ...
        <a href="{{ route('monitoring.icu.workspace', [
           ...
           wire:navigate
           class="inline-flex items-center justify-center gap-1.5 sm:gap-2 bg-blue-600 hover:bg-blue-700 text-white px-4 sm:px-8 py-2 sm:py-3 rounded-md font-medium text-sm sm:text-base shadow hover:shadow-md transition-all">
                        ...
                        <tr class="hover:bg-blue-50 transition-colors">
                            ...
                            <td class="px-3 py-2 text-right">
                                <a href="{{ route('monitoring.icu.workspace', [
                                   ...
                                   wire:navigate
                                   class="inline-flex items-center text-blue-600 hover:text-blue-800 font-medium text-xs sm:text-sm">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-3.5 w-3.5 mr-1" fill="none"
                                         viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                        <path stroke-linecap="round" stroke-linejoin="round"
                                              d="M15 12H3m0 0l4 4m-4-4l4-4m10 8h4v-8h-4" />
                                    </svg>
                                    Buka
                                </a>
                            </td>

...
class AnesthesiaCreate extends Component
{
    ...
    public function save()
    {
        ...
        $mainData = [
            ...
            'cvc' => $this->cvc,
            'posisi' => $this->posisi,
            'perlindungan_mata' => $this->perlindungan_mata,
            ...
            'jalan_nafas_oro_nasopharing' => $this->jalan_nafas_oro_nasopharing,
            ...
            'jalan_nafas_trakheostomi' => $this->jalan_nafas_trakheostomi,
            'jalan_nafas_bronkoskopi_fiberoptik' => $this->jalan_nafas_bronkoskopi_fiberoptik,
            'jalan_nafas_glidescope' => $this->jalan_nafas_glidescope,
            'jalan_nafas_lain_lain' => $this->jalan_nafas_lain_lain,
            'intubasi_kondisi' => $this->intubasi_kondisi,
            'intubasi_jalan' => $this->intubasi_jalan,
            'sulit_ventilasi' => $this->sulit_ventilasi,
            'sulit_intubasi' => $this->sulit_intubasi,
            ...
            'regional_kateter' => $this->regional_kateter,
